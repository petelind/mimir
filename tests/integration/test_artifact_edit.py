...
class TestArtifactEdit:
    ...
    def test_art_edit_02_edit_name(self):
        ...
        assert response.url == reverse('artifact_detail', kwargs={'pk': self.artifact.pk})
    ...
    def test_art_edit_03_edit_description(self):
        ...
        self.artifact.refresh_from_db()
        assert self.artifact.description == 'Updated comprehensive REST API documentation'
    ...
    def test_validate_required_name(self):
        ...
        assert response.status_code == 200
        assert b'Artifact name cannot be empty' in response.content or b'This field is required' in response.content
