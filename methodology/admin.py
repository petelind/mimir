...
class ActivityAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'workflow', 'phase', 'status', 'order', 'has_dependencies')
    list_filter = ('status', 'phase', 'has_dependencies', 'created_at')
    ...
    fieldsets = (
        ...
        ('Organization', {
            'fields': ('order', 'phase', 'status', 'has_dependencies')
        }),
        ('Timestamps', {
